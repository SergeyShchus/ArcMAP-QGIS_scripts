...
c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Config\sample0 currFolder %var% *.xml
c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Config\sample1 currFolder %var% *.xml
c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Config\sample2 currFolder %var% *.xml
c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\RasterFunctionTemplates currFolder %var% *.xml
c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Rastertype currFolder %var% *.xml
...
echo @echo This batch file will reset the ArcGIS version number and current folder location to be used by the Elevation Batch files. >>Reset_Script_Paths.bat
...
echo. >>Reset_Script_Paths.bat
echo c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Config\sample0 %var% currFolder *.xml >>Reset_Script_Paths.bat
echo. >>Reset_Script_Paths.bat
echo c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Config\sample1 %var% currFolder *.xml >>Reset_Script_Paths.bat
echo. >>Reset_Script_Paths.bat
echo c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Config\sample2 %var% currFolder *.xml >>Reset_Script_Paths.bat
echo. >>Reset_Script_Paths.bat
echo c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\RasterFunctionTemplates %var% currFolder *.xml >>Reset_Script_Paths.bat
echo. >>Reset_Script_Paths.bat
echo c:\python27\arcgis%id%\python.exe %var%\scripts\search_replace.py %var%\Parameter\Rastertype %var% currFolder *.xml >>Reset_Script_Paths.bat
echo. >>Reset_Script_Paths.bat
echo pause >>Reset_Script_Paths.bat
